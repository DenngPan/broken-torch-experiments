...
model:add(nn.SpatialBatchNormalization(64, 1e-3))
model:add(cudnn.ReLU())
model:add(cudnn.SpatialConvolution(64, 64, 3,3, 1,1))
model:add(nn.SpatialBatchNormalization(64, 1e-3))
model:add(cudnn.ReLU())
model:add(cudnn.SpatialConvolution(64, 256, 3,3, 2,2))
model:add(nn.SpatialBatchNormalization(256, 1e-3))
model:add(cudnn.ReLU())
model:add(cudnn.SpatialConvolution(256, 256, 1,1, 1,1))
model:add(nn.SpatialBatchNormalization(256, 1e-3))
model:add(cudnn.ReLU())
model:add(cudnn.SpatialConvolution(256, 256, 3,3, 1,1))
model:add(nn.SpatialBatchNormalization(256, 1e-3))
model:add(cudnn.ReLU())
model:add(nn.Dropout(0.5))
model:add(cudnn.SpatialConvolution(256, 512, 3,3, 2,2))
model:add(nn.SpatialBatchNormalization(512, 1e-3))
model:add(cudnn.ReLU())
model:add(cudnn.SpatialConvolution(512, 512, 1,1, 1,1))
model:add(cudnn.ReLU())
model:add(cudnn.SpatialConvolution(512, 957, 3,3, 1,1))
model:add(cudnn.ReLU())
